...
public class AdaptadorPromociones extends PagerAdapter {
    ...
    private Integer [] images = {R.drawable.promo1,R.drawable.promo2, R.drawable.promo3,R.drawable.promo4, R.drawable.promo5,R.drawable.promo6};

    public AdaptadorPromociones(Context context) {
